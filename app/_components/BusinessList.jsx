                ...
                rounded-lg hover:shadow-lg cursor-pointer
                 ...
                 hover:scale-105 transition-all ease-in-out'>
                    ...
                    items-baseline p-3 gap-1'>
                        ...
                        text-purple-500 rounded-full px-2
                         text-[12px]'>{business.category.name}</h2>
                        <h2 className='font-bold text-lg'>{business.name}</h2>
                        <h2 className='text-indigo-700'>{business.contactPerson}</h2>
                        <h2 className='text-gray-500 text-sm'>{business.address}</h2>
                        <Button className=" bg-blue-700 text-white rounded-lg mt-3">Book Now</Button>
                    </div>
                </Link>
            ))
              :
