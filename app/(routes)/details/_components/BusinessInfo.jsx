...
function BusinessInfo({business}) {
  return business?.name&&(
   ...
   <div className='flex flex-col gap-5 items-end'>
    <Button><Share/></Button>
    <h2 className='flex gap-2 text-xl text-purple-600'><User/> {business.contactPerson} </h2>
